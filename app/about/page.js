...
export const metadata = {
  ...
  description: 'COCO&Bridge（田村 恵）のコンセプト・代表プロフィール・会社概要をご紹介します。',
}
          ...
          <tbody>
            {overview.map((item, i) => (
              <tr key={i} style={{ borderBottom: '1px solid var(--gray-200)' }}>
                <th style={{ padding: '16px 24px', textAlign: 'left', color: 'var(--navy)', fontWeight: '600', width: '200px' }}>
                  {item['項目名']}
                </th>
